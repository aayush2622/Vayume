{
  ...
  flake.homeModules.apps.Vesktop =
    {
      self,
      pkgs,
      lib,
    ...
    let
      discordTemplate =
        lib.replaceStrings [ "@@FONT@@" ] [ vayumeTheme.font ]
          self.matugenTemplates.discord;
    ...
    in
    {
      programs.vesktop = {
        ...
        vencord.settings = vencordSettings // {
          plugins = vencordPlugins;
        };
      };
