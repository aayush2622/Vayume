  ...
  perSystem =
    ...
    let
      ...
      niriBinds = {
        ...
        "Mod+S" = titled "Toggle App Launcher" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "Mod+Comma" = titled "Open Settings" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "Mod+Shift+W" = titled "Open Wallpaper Carousel" {
          spawn = [
            "dms"
            "ipc"
            "wallpaperCarousel"
        ...
        "Mod+A" = titled "Toggle App Launcher" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "Print" = titled "Screenshot (region)" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "XF86AudioMute" = titled "Mute Audio" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "XF86AudioLowerVolume" = titled "Volume Down" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "XF86AudioRaiseVolume" = titled "Volume Up" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "XF86AudioMicMute" = titled "Mute Microphone" {
          spawn = [
            "dms"
            "ipc"
            "call"
        ...
        "XF86AudioPlay" = titled "Play/Pause Media" {
          spawn = [
            "playerctl"
            "play-pause"
          ];
        };
        "XF86AudioPause" = titled "Play/Pause Media" {
          spawn = [
            "playerctl"
            "play-pause"
          ];
        };
        "XF86AudioNext" = titled "Next Track" {
          spawn = [
            "playerctl"
            "next"
          ];
        };
        "XF86AudioPrev" = titled "Previous Track" {
          spawn = [
            "playerctl"
            "previous"
          ];
