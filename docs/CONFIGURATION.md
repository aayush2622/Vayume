...
7. [vayume/Commands.nix](core-commands.md) (the `vayume` command)
8. [vayume/Settings.nix](core-settings.md) (every `vayume.*` option in the panel)
9. [core/DevLanguages.nix](core-devlanguages.md)
10. [core/PluginUpdateCheck.nix](core-pluginupdatecheck.md)

**Desktop** - the part you actually look at all day
11. [desktop/Dms.nix](desktop-dms.md)
12. [desktop/Niri.nix](desktop-niri.md)
13. [desktop/Hyprland.nix](desktop-hyprland.md)
14. [desktop/DefaultApps.nix](desktop-default-apps.md) (`vayume.defaultApps`)
15. [desktop/Fonts.nix / Portals.nix](desktop-portals-fonts.md)
16. [desktop/Theming.nix](desktop-theming.md)
17. [desktop/Matugen.nix](desktop-matugen.md)
18. [desktop/sddm/SddmTheme.nix](desktop-sddm.md)

**System** - infrastructure that doesn't care what desktop you're running
19. [system/Misc.nix](system-misc.md) (Zram, DevTooling, GrubTheme)
20. [system/Performance.nix](system-performance.md) (`vayume.performance`)
21. [system/Network.nix](system-network.md)
22. [system/waydroid/Waydroid.nix](system-waydroid.md)

**Apps - development**
23. [apps/development/editors/androidStudio/AndroidStudio.nix](apps-dev-androidstudio.md)
24. [apps/development/editors/vscode/Vscode.nix](apps-dev-vscode.md)
25. [apps/development/editors/zed/Zed.nix](apps-dev-zed.md)
26. [apps/development/languages/\*/\*.nix](apps-dev-languages.md) (Cpp, Rust, Kotlin, Flutter [+Dart], Nix, Qt, Python)
27. [apps/development/devTools/DevTools.nix](apps-dev-devtools.md)
28. [apps/development/ccSwitch/CcSwitch.nix](apps-dev-ccswitch.md)

**Apps - gaming**
29. [apps/gaming/Gaming.nix](apps-gaming.md)

**Apps - utils**
30. [apps/utils/zenBrowser/ZenBrowser.nix](apps-utils-zenbrowser.md)
31. [apps/utils/spicetify/Spicetify.nix](apps-utils-spicetify.md)
32. [apps/utils/spotifast/Spotifast.nix](apps-utils-spotifast.md)
33. [apps/utils/nautilus/Nautilus.nix](apps-utils-nautilus.md)
34. [apps/utils/thunar/Thunar.nix](apps-utils-thunar.md)
35. [apps/utils/bitwarden/Bitwarden.nix](apps-utils-bitwarden.md)
36. [apps/utils/stateBackup/StateBackup.nix](apps-utils-statebackup.md)
37. [apps/utils/terminal/Terminal.nix](apps-utils-terminal.md)
38. [apps/utils/vesktop/Vesktop.nix](apps-utils-vesktop.md)
39. [apps/utils/distrobox/Distrobox.nix](apps-utils-distrobox.md)
